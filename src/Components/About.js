            ...
            <div className="about-me-card">
                <div className="about-me-content">
                    <div className="about-me-left">
                        <h3>Hey there!</h3>
                        <p>I'm Ajiboye, a dynamic and innovative Software Developer hailing from the vibrant city of Lagos, Nigeria. With a deep-rooted passion for crafting digital experiences and a solid background in Web Development, I've spent the past 3 years honing my skills and pushing the boundaries of what's possible in the world of web development.</p>
