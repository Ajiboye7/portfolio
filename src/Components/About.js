            ...
            <div className="about-me-card">
                <div className="about-me-content">
                    <div className="about-me-left">
                        <h3>Hey there!</h3>
                        <p>I'm Ajiboye, a dynamic and innovative Web Developer hailing from the vibrant city of Lagos, Nigeria. With a deep-rooted passion for crafting digital experiences and a solid background in Web Development, I've spent the past 3 years honing my skills and pushing the boundaries of what's possible in the world of web development.</p>
                    ...
                    <div className="about-me-right">
                        ...
                        <ul className="skill-list">
                            ...
                            <li>HTML and CSS: Strong skills in HTML and CSS, including knowledge of responsive design, CSS preprocessors like Sass, and CSS frameworks like Bootstrap.</li>
                            ...
                            <li>Project Management: Understanding of project management methodologies, including Agile, Scrum, and Kanban, and experience working in an agile development environment.</li>
                        </ul>
                        </ul>
                    </div>
                </div>
